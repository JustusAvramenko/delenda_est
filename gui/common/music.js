...
{
	this.tracks = {
		MENU: ["Heart_of_Courage.ogg"],
		PEACE: [],
		BATTLE: ["Rise_and_Fall_Battle_02.ogg", "Rise_and_Fall_Battle_01.ogg", "Rise_and_Fall_Battle_03.ogg", "Rise_and_Fall_Battle_05.ogg", "Rise_and_Fall_Battle_11.ogg"],
		VICTORY : ["Alexander_Going_Home.ogg"],
		DEFEAT : ["Rise_and_Fall_Mourn_for_the_Dead.ogg"]
	};
};

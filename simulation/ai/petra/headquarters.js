...
m.HQ.prototype.checkBaseExpansion = function(gameState, queues)
{
	...
	// If already we've already planned to phase up, wait a bit before trying to expand
	if (this.phasing)
		return;
...
m.HQ.prototype.update = function(gameState, queues, events)
{
	...
	if (this.numActiveBase() < 1 ||
		(this.Config.difficulty > 0 && gameState.ai.playedTurn % 10 == 7 && this.currentPhase > 1))

...
import * as difficultyLevel from "simulation/ai/nike/difficultyLevel.js";
...
export class Config
{
	...
	setConfig(gameState)
	{
		...
		// Nike usually uses the continuous values of personality.aggressive and personality.defensive
		...
		if (this.debug < 2)
			return;
		aiWarn(" >>>  Nike bot: personality = " + uneval(this.personality));
	}
